...
const Landing = () => {
	return (
		<div className="relative min-h-screen bg-white overflow-hidden flex flex-col justify-between">
			...
			<div className="relative z-10 flex flex-row px-16 xl:px-8 md:px-4 max-w-7xl mx-auto gap-12 lg:flex-col lg:gap-6 pb-16">
				{/* Left content section */}
				<div className="flex-1 flex flex-col justify-center pt-0 lg:items-center md:items-start">
					{/* Tag */}
					<div className="inline-flex w-fit items-center rounded-full border px-4 py-2 text-sm mt-8 mb-2 bg-blue-50 border-blue-200 text-blue-900 lg:mt-4">
					...
					<h1 className="text-5xl xl:text-4xl lg:text-center md:text-left md:text-3xl font-bold tracking-tight text-gray-900 mb-6">
						...
						<span className="block mt-2 text-6xl xl:text-5xl lg:text-center md:text-left md:text-4xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-600">
							UpSkill Classes
						</span>
					</h1>
					...
					<div className="grid grid-cols-2 xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-1 gap-4 mb-8 w-full max-w-xl">
						...
						<Card className="p-4 border-none bg-gray-50">
							...
							<p className="text-sm text-gray-600">
								Receive actionable insights to improve your communication skills
							</p>
						</Card>
					</div>
					...
					<div className="flex items-center gap-6 mb-2">
						<Button
							size="lg"
							className="text-lg xl:text-base md:text-sm h-14 xl:h-12 px-8 xl:px-6 whitespace-nowrap hover:scale-110 transition-transform duration-300 ease-in-out "
						>
							<SignInButton>Start Talking</SignInButton>
				...
				{/* Right section */}
				<div className="flex-1 flex items-center justify-center min-h-[400px] xl:min-h-[350px] lg:min-h-[300px] md:min-h-[200px]">
